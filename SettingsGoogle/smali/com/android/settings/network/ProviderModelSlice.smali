...
.method public getSlice()Landroidx/slice/Slice;
    ...
    invoke-virtual {v5}, Lcom/android/settings/network/ProviderModelSliceHelper;->isAirplaneModeEnabled()Z
    ...
    invoke-virtual {v5}, Lcom/android/settings/network/ProviderModelSliceHelper;->hasCarrier()Z
    ...
    .line 142
    :cond_4
    iget-object v5, p0, Lcom/android/settings/wifi/slice/WifiSlice;->mWifiManager:Landroid/net/wifi/WifiManager;
    ...
    invoke-virtual {p0, v6, v5}, Lcom/android/settings/network/ProviderModelSlice;->createWifiToggleRow(Landroid/content/Context;Z)Landroidx/slice/builders/ListBuilder$RowBuilder;
    ...
    invoke-virtual {v4, v1}, Lcom/android/settings/network/ProviderModelSliceHelper;->getConnectedWifiItem(Ljava/util/List;)Lcom/android/settings/wifi/slice/WifiSliceItem;

    move-result-object v4

    if-eqz v4, :cond_8

    const-string v5, "get Wi-Fi item which is connected"
    ...
    new-instance v4, Lcom/android/settings/network/ProviderModelSlice$$ExternalSyntheticLambda2;

    invoke-direct {v4}, Lcom/android/settings/network/ProviderModelSlice$$ExternalSyntheticLambda2;-><init>()V
