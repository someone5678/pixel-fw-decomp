...
# direct methods
.method public constructor <init>(Landroid/hardware/display/DisplayManager;Landroid/app/IActivityTaskManager;Lkotlinx/coroutines/CoroutineDispatcher;)V
    .locals 0
    ...
    .line 2
    .line 3
    iput-object p1, p0, Lcom/android/systemui/screenshot/ImageCaptureImpl;->displayManager:Landroid/hardware/display/DisplayManager;
...
.method public final captureDisplay(ILandroid/graphics/Rect;)Landroid/graphics/Bitmap;
    ...
    .line 3
    invoke-virtual {p0, p1}, Lcom/android/systemui/screenshot/ImageCaptureImpl;->physicalDisplayToken(I)Landroid/os/IBinder;
    ...
    .line 4
    :cond_0
    invoke-virtual {p0, p1, v0, v1, p2}, Lcom/android/systemui/screenshot/ImageCaptureImpl;->captureDisplay(Landroid/os/IBinder;IILandroid/graphics/Rect;)Landroid/view/SurfaceControl$ScreenshotHardwareBuffer;
...
.method public captureDisplay(Landroid/os/IBinder;IILandroid/graphics/Rect;)Landroid/view/SurfaceControl$ScreenshotHardwareBuffer;
    .locals 0
    ...
    .line 7
    invoke-virtual {p0, p2, p3}, Landroid/view/SurfaceControl$DisplayCaptureArgs$Builder;->setSize(II)Landroid/view/SurfaceControl$DisplayCaptureArgs$Builder;

    move-result-object p0

    .line 8
    invoke-virtual {p0, p4}, Landroid/view/SurfaceControl$DisplayCaptureArgs$Builder;->setSourceCrop(Landroid/graphics/Rect;)Landroid/view/SurfaceControl$CaptureArgs$Builder;
...
.method public final captureTask(ILkotlin/coroutines/jvm/internal/ContinuationImpl;)Ljava/lang/Object;
    .locals 0
...
.method public physicalDisplayToken(I)Landroid/os/IBinder;
    .locals 3

    .line 0
    iget-object p0, p0, Lcom/android/systemui/screenshot/ImageCaptureImpl;->displayManager:Landroid/hardware/display/DisplayManager;
    ...
    .line 7
    const-string v1, "ImageCaptureImpl"
    ...
    .line 10
    .line 11
    const-string p0, "No display with id: "
    ...
    .line 21
    instance-of v2, p1, Landroid/view/DisplayAddress$Physical;
    ...
    .line 29
    .line 30
    const-string v2, "Display does not have a physical address: "
    ...
    .line 52
    invoke-static {p0, p1}, Landroid/view/SurfaceControl;->getPhysicalDisplayToken(J)Landroid/os/IBinder;
