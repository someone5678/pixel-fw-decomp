...
.method public final onBind()V
    ...
    invoke-virtual {v0}, Lcom/android/systemui/media/dialog/MediaOutputController;->isAdvancedLayoutSupported()Z
    ...
    invoke-direct {v1, v2, p0}, Lcom/android/systemui/qs/tiles/dialog/InternetDialog$$ExternalSyntheticLambda4;-><init>(ILjava/lang/Object;)V
...
.method public final onBind(Lcom/android/settingslib/media/MediaDevice;I)V
    ...
    invoke-virtual {v4, p1}, Lcom/android/systemui/media/dialog/MediaOutputBaseAdapter;->isCurrentlyConnected(Lcom/android/settingslib/media/MediaDevice;)Z
    ...
    iget v7, v6, Lcom/android/systemui/media/dialog/MediaOutputBaseAdapter;->mCurrentActivePosition:I
    ...
    .line 29
    iput v7, v6, Lcom/android/systemui/media/dialog/MediaOutputBaseAdapter;->mCurrentActivePosition:I
    ...
    invoke-virtual {v6}, Lcom/android/systemui/media/dialog/MediaOutputController;->isAnyDeviceTransferring()Z
    ...
    .line 47
    invoke-virtual {v6}, Lcom/android/systemui/media/dialog/MediaOutputController;->isCurrentConnectedDeviceRemote()Z
    ...
    .line 51
    invoke-virtual {p0, v7, v0}, Lcom/android/systemui/media/dialog/MediaOutputBaseAdapter$MediaDeviceBaseViewHolder;->updateTitleIcon(II)V
    ...
    invoke-direct {p2, v2, p0, p1}, Lcom/android/systemui/statusbar/notification/row/NotificationInfo$$ExternalSyntheticLambda1;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V
    ...
    .line 69
    iget-object v6, v6, Lcom/android/systemui/media/dialog/MediaOutputController;->mFeatureFlags:Lcom/android/systemui/flags/FeatureFlags;

    .line 70
    sget-object v8, Lcom/android/systemui/flags/Flags;->TEAMFOOD:Lcom/android/systemui/flags/UnreleasedFlag;

    invoke-interface {v6}, Lcom/android/systemui/flags/FeatureFlags;->isEnabled()V

    .line 71
    iget v6, p1, Lcom/android/settingslib/media/MediaDevice;->mState:I
    ...
    invoke-direct {p2, p0, p1}, Lcom/android/systemui/media/dialog/MediaOutputAdapter$MediaDeviceViewHolder$$ExternalSyntheticLambda0;-><init>(Lcom/android/systemui/media/dialog/MediaOutputAdapter$MediaDeviceViewHolder;Lcom/android/settingslib/media/MediaDevice;)V
    ...
    .line 120
    invoke-virtual {p0, v2, p2, p1}, Lcom/android/systemui/media/dialog/MediaOutputAdapter$MediaDeviceViewHolder;->updateGroupableCheckBox(ZZLcom/android/settingslib/media/MediaDevice;)V
    ...
    .line 122
    iget-object p2, p0, Lcom/android/systemui/media/dialog/MediaOutputBaseAdapter$MediaDeviceBaseViewHolder;->mContainerLayout:Landroid/view/ViewGroup;

    invoke-virtual {p0, p2, v3, p1}, Lcom/android/systemui/media/dialog/MediaOutputAdapter$MediaDeviceViewHolder;->setUpContentDescriptionForView(Landroid/view/ViewGroup;ZLcom/android/settingslib/media/MediaDevice;)V
    ...
    .line 125
    invoke-virtual/range {v6 .. v11}, Lcom/android/systemui/media/dialog/MediaOutputBaseAdapter$MediaDeviceBaseViewHolder;->setSingleLineLayout(Ljava/lang/CharSequence;ZZZZ)V

    .line 126
    invoke-virtual {p0, p1, v5}, Lcom/android/systemui/media/dialog/MediaOutputBaseAdapter$MediaDeviceBaseViewHolder;->initSeekbar(Lcom/android/settingslib/media/MediaDevice;Z)V
    ...
    invoke-direct {p2, v3, p0}, Lcom/android/systemui/media/dialog/MediaOutputAdapter$MediaDeviceViewHolder$$ExternalSyntheticLambda1;-><init>(ILjava/lang/Object;)V
    ...
    invoke-virtual {p0, v0, v3, p1}, Lcom/android/systemui/media/dialog/MediaOutputAdapter$MediaDeviceViewHolder;->setUpContentDescriptionForView(Landroid/view/ViewGroup;ZLcom/android/settingslib/media/MediaDevice;)V
    ...
    .line 151
    invoke-virtual {p0, v3, v2, p1}, Lcom/android/systemui/media/dialog/MediaOutputAdapter$MediaDeviceViewHolder;->updateGroupableCheckBox(ZZLcom/android/settingslib/media/MediaDevice;)V
    ...
    invoke-virtual {p2}, Lcom/android/systemui/media/dialog/MediaOutputController;->isAdvancedLayoutSupported()Z
    ...
    invoke-direct {p2, p0, p1}, Lcom/android/systemui/media/dialog/MediaOutputAdapter$MediaDeviceViewHolder$$ExternalSyntheticLambda2;-><init>(Lcom/android/systemui/media/dialog/MediaOutputAdapter$MediaDeviceViewHolder;Lcom/android/settingslib/media/MediaDevice;)V
    ...
    .line 165
    new-instance p2, Lcom/android/systemui/media/dialog/MediaOutputAdapter$MediaDeviceViewHolder$$ExternalSyntheticLambda3;

    invoke-direct {p2, p0, p1}, Lcom/android/systemui/media/dialog/MediaOutputAdapter$MediaDeviceViewHolder$$ExternalSyntheticLambda3;-><init>(Lcom/android/systemui/media/dialog/MediaOutputAdapter$MediaDeviceViewHolder;Lcom/android/settingslib/media/MediaDevice;)V
    ...
    invoke-virtual {p1}, Lcom/android/systemui/media/dialog/MediaOutputController;->isAdvancedLayoutSupported()Z
...
.method public final onGroupActionTriggered(Lcom/android/settingslib/media/MediaDevice;Z)V
    ...
    .line 11
    .line 12
    invoke-virtual {v2}, Lcom/android/systemui/media/dialog/MediaOutputController;->getSelectableMediaDevice()Ljava/util/ArrayList;
    ...
    .line 54
    invoke-static {p2, v3, v2}, Lcom/android/systemui/shared/system/SysUiStatsLog;->write(Ljava/lang/String;II)V
    ...
    .line 61
    .line 62
    iput v1, p1, Lcom/android/settingslib/media/MediaDevice;->mState:I
...
.method public final onItemClick(Lcom/android/settingslib/media/MediaDevice;)V
    ...
    .line 133
    :cond_4
    new-instance v1, Lcom/android/systemui/media/dialog/MediaOutputController$$ExternalSyntheticLambda1;

    .line 134
    .line 135
    invoke-direct {v1, v0, p1}, Lcom/android/systemui/media/dialog/MediaOutputController$$ExternalSyntheticLambda1;-><init>(Lcom/android/systemui/media/dialog/MediaOutputController;Lcom/android/settingslib/media/MediaDevice;)V

    .line 136
    .line 137
    .line 138
    invoke-static {v1}, Lkotlin/io/CloseableKt;->postOnBackgroundThread(Ljava/lang/Runnable;)Ljava/util/concurrent/Future;
...
.method public final setUpContentDescriptionForView(Landroid/view/ViewGroup;ZLcom/android/settingslib/media/MediaDevice;)V
    .locals 2
...
.method public final updateEndClickArea(Lcom/android/settingslib/media/MediaDevice;Z)V
    ...
    .line 32
    .line 33
    invoke-virtual {p0, p2, v0, p1}, Lcom/android/systemui/media/dialog/MediaOutputAdapter$MediaDeviceViewHolder;->setUpContentDescriptionForView(Landroid/view/ViewGroup;ZLcom/android/settingslib/media/MediaDevice;)V
...
.method public final updateGroupableCheckBox(ZZLcom/android/settingslib/media/MediaDevice;)V
    ...
    .line 16
    .line 17
    invoke-direct {v1, p0, p1, p3}, Lcom/android/systemui/media/dialog/MediaOutputAdapter$MediaDeviceViewHolder$$ExternalSyntheticLambda5;-><init>(Lcom/android/systemui/media/dialog/MediaOutputAdapter$MediaDeviceViewHolder;ZLcom/android/settingslib/media/MediaDevice;)V
    ...
    .line 61
    .line 62
    invoke-direct {p0, p3, p2}, Landroid/content/res/ColorStateList;-><init>([[I[I)V
